  ...
  return (
    <div className={'testimonial bg-gray2 py-20'}>
      <div className={'flex flex-col justify-center items-center'}>
        <FormText type='subtitle' title='TESTIMONIAL' />
        <FormText
          type='title'
          customClass='mt-6'
      ...
      <div className={'flex justify-center items-center mt-7'}>
        <Link to={RouteNames.resouce_story} className={` mt-6 px-6 py-4 rounded-xl   bg-white text-black1 text-18 leading-7 font-semibold `}>More success stories</Link>
      </div>
    </div>
  );
};
